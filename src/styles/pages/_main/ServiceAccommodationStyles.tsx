...
export const ServiceAccommodationStyles = styled.div`
  display: flex;
...
export const ContainerServiceAccommodation = styled.div`
  width: 100%;
  margin: 6rem 0rem;
...
`
export const ContainerListPrices = styled.div`
  width: 100%;
  max-width: 1210px;
