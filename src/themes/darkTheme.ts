export const darkTheme = {
  colors: {
    ...
    'base-text-gray': '#acacac',
    'base-border-gray': '#d6d6d6a6',
    'brand-base-dark': '#010627',
    'brand-super-dark': '#000313',
    'brand-primary-dark': '#010627',
    'brand-primary': '#b882fc',
    'brand-primary-light': '#EBE5F9',
    'brand-secondary-dark': '#052931',
    'brand-secondary': '#3997A9',
    'brand-secondary-light': '#6CACB8cc',
    'brand-pink': '#b882fc',
    'brand-pink-dark': '#5f2dee'
  },
  textSizes: {
    'title-title-xl': '3rem',
    'title-title-l': '2rem',
